...
<script type="text/javascript">
	...
	$(document).ready(function() {
	   ...
	   var value ='https://qr.alipay.com/fkx04105izxjwnucqm1iq45?t=1542247964696';
	   function makeQR() {
   ...
   <div class="category">
    ...
    <section class="phonewrap2">
             ...
             <div style="width:100%; height:200px; text-align:center; margin: auto;">
             	<img alt="" style="width: 400px;height: 200px;" src="${path}/apppay/images/zfb.jpg">            
             </div>
             ...
             <div style="width:100%; height:20px; text-align:center; margin: auto;">            	
				...
				<div id="qr" style="width:200px; height:200px; text-align:center; margin: auto;" ></div>
             </div>
