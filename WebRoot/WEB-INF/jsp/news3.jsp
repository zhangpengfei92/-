...
function  serach(pageNum) {
	...
	window.location.href = "${path}/news/zxdt/"+pageNum;
}
...
<input type="hidden" value="${num}" id="newstype">
    <ul class="tit">
          ...
          <li class="select" onclick="selectNews('3')" id="news3">市场动态</li>
    ...
    <div class="hides" style="display:block;min-height:300px;" id="div1">
       ...
       <c:forEach items="${nlist}" var="sn">
       	<li >
            <a href="javascript:;" onclick="querydetails(${sn.nid})">
               <div class="Nimg">
                  <img img style='width:199px;height:135px;' src="${sn.imgurl}" />
               </div>
               <div class="Nact">
                  <p class="date">
                  ...
                  <div class="News">
                      ...
                      <p>${sn.summary}</p>
                      <p class="Detail"  onclick="querydetails(${sn.nid})">查看详情</p>
                  </div>
               </div>
            </a>
        </li>
