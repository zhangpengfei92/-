...
<script type="text/javascript">
	...
	function saveUser() {
		...
		if(regFlag){
			$.ajax({
				url : "${path}/feeTemplate/editfeeSchemeMsg",
				data : {
					'title' : username,
					'agentzh' : $("#agentzh").val(),
					'id' : id
	...
	<div class="wrap">
		...
		<div class="Rbox">
     		<div class="mainbox">
                   ...
                   <div class="main">
        		   		<input type="hidden" value="${user.id}" name="lsh" id="lsh"/>
        		   		<input type="hidden" value="${user.agentzh}" id="agentzh" name="agentzh"/>
                      	<div class="Form">
                            <div class="dline">
                                <label>方案名称：</label>
			                   	<p><input type="text" name="schemename" id="schemename" maxlength="30" placeholder="请输入手续费收费方案名称" value="${user.title}"/></p>
                            </div>
                            <div class="dline">
