              	...
              	<ul class="subnav">
					...
					<shiro:hasRole name="zhlist">
		             ...
		             <shiro:hasRole name="bdzh">
              		...
              		<shiro:hasRole name="sxfc">
	              	<li class="subnav-li" data-id="11" id="index_11"><a id="left_a_11" href="javascript:;" onclick="feeTemplateList()" class="ue-clear"><span class="subnav-text">手续费分成方案</span></a></li>
	              	</shiro:hasRole>
              	</ul>
            </li>
           ...
           <%--  <li class="nav-li last-nav-li" id="nav_4">
                ...
                <ul class="subnav">
		         ...
		         <c:if test="${sessionScope.SESSION_LOGINNAME == '1272'}">
		             	<li class="subnav-li" data-id="12" id="index_12"><a id="left_a_12" href="javascript:;" onclick="wardenList('12')" class="ue-clear"><span class="subnav-text">系统账户</span></a></li>
		             </c:if>
			<shiro:hasRole name="app_help"> 
			          		<li class="subnav-li" data-id="21" id="index_21"><a id="left_a_21" href="javascript:;" onclick="toApp()" class="ue-clear"><span class="subnav-text">APP帮助</span></a></li>
			    </shiro:hasRole>            		
