	...
	<c:if test="${status eq 0 }">
		...
		$(function(){
			...
			$.post("${path}/trade/getTotalFund",formdate,function(data){
				if(data !=null ){
					html=html+"<td>合计:</td><td></td><td></td><td></td><td></td><td>"+data.totalRight.toFixed(2)+"</td><td>"+data.total.toFixed(2)+"</td><td>"+data.position_profit.toFixed(2)+"</td><td>"+data.margi.toFixed(2)+"</td><td>"+data.freeze.toFixed(2)+"</td><td>"+data.available.toFixed(2)+"</td><td>"+data.fee.toFixed(2)+"</td><td></td>";
				}else{
