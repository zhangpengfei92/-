...
<script type="text/javascript">
	...
	function refreshPage() {
		<c:if test="${empty user.pcfee1}">window.location.href = "${path}/codefeeset/codefeesetList?usertype="+$("#parentid").val();</c:if>
		<c:if test="${!empty user.pcfee1}">location.replace(document.referrer);</c:if>
	}
                 ...
                 <div class="main">
                      	<div class="Form">
			                 <form id="infoInputForm" name="infoInputForm" method="post" action="">
						        ...
						        <div class="dline">
						          	<label><font color="red">*</font>平仓手续费(按手数)：</label>
