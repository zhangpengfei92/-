...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
			...
			<div class="mtable">
                <table width="100%;">
						...
						<tr>
							...
							<td><fmt:formatNumber type="number" value="${fund.occur_balance}" maxFractionDigits="2"/></td>
							<td>${fund.rate}%</td>
						</tr>
					</c:forEach>
					<tr id="currtable">
	...
	<script type="text/javascript">
		$(function(){
		     ...
		     var html='';
			$.post("${path}/trade/getCountLsFund",formdate,function(data){
				console.log(data);
				if(data !=null ){
					html=html+"<td>合计:</td> <td></td> <td></td> <td></td> <td></td> <td></td> <td>"+data.countPreFundBalance.toFixed(2)+"</td> <td>"+data.countOutcomingBalance.toFixed(2)+"</td><td>"+data.countIncomingBalance.toFixed(2)+"</td><td>"+data.countFreezeBalance.toFixed(2)+"</td><td>"+data.countFee.toFixed(2)+"</td><td>"+data.countTotalCloseprofit.toFixed(2)+"</td><td>"+data.countTotalFloatprofit.toFixed(2)+"</td><td></td>";
				}else{
