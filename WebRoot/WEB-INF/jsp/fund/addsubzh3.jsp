...
<script type="text/javascript">
	...
	function checkScheme() {
		...
		var schemes=codeids+"-"+bzjids+"-"+raskids;
		alert(codeids+"        "+bzjids+"       "+raskids);
		alert(schemes);
	}
                      	...
                      	<div class="Form">
                           ...
                           <c:if test="${sub.isadmin eq 6 }">
                            ...
                            <c:if test="${sub.isadmin lt 6 }">
	                            ...
	                            <%-- <div class="dline">
	                                <label>分成系数：</label>
						            <p><input type="text" value="<fmt:formatNumber value="${sub.coefficient}" pattern="#.#######"/>" 
						            name="coefficient" id="coefficient" onblur="checkNum(this.value)" style="width:380px;"/>%</p>
	                            </div> --%>
                            </c:if>
                            <div class="dline">
							...
							<c:if test="${sub.isadmin == 3}">
								<div class="tabdiv">
									 <table width="100%">
									 	<tr>
				        					<td style="text-align:center;" colspan="111">
		        								<label style="font-size: 20px">关联方案</label>
				        					</td>
				    					</tr>
										<tr>
				        					...
				        					<c:forEach items="${clist}" var="cf" varStatus="stc">
						        				<td style="text-align: left;">
						        						<input type="checkbox"  value="${cf.id}" name="codeid"/>
						        						<i style="padding: 0 5px">${cf.title}</i>
						        				</td>
						        				<td colspan="111"></td>
				        					</c:forEach>
				    					</tr>
				    					<tr>
				        					<td style="text-align:center;">
				       						...
				       						<c:forEach items="${blist}" var="bl" varStatus="stb">
					        					<td style="text-align: left;">
					        						<input type="checkbox" value="${bl.id}" name="bzjid"/>
					        						<i style="padding: 0 5px">${bl.title}</i>
					        					</td>
				        					</c:forEach>
				        					<td colspan="111"></td>
				    					</tr>
				    					<tr>
				        					<td style="text-align:center;">
				       						...
				       						<c:forEach items="${rlist}" var="rl" varStatus="str">
					        					<td style="text-align: left;">
					        						<input type="checkbox"  value="${rl.id}" name="raskid"/>
					        						<i style="padding: 0 5px">${rl.type}</i>
					        					</td>
				        					</c:forEach>
				        					<td colspan="111"></td>
				    					</tr>
									...
									<button  onclick="checkScheme();" id="submitId">点了一下</button>
									</c:if>
								<div class="dline">
