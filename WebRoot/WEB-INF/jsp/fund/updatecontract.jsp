		...
		if(regFlag){
			$.ajax({
				...
				success : function(num) {
						/* <c:if test="${!empty con.promptDay}"></c:if> */
            	  ...
            	  <input type="hidden" value="${cids}" id="cids" name="cids" />	
                	 <div class="laydline">
                    	...
                    	<div class="laydline">
                           ...
                           <div class="laydline">
                            <label>到期时间：</label>
                                 <input type="text" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" value="<fmt:formatDate value="${con.promptDay}" pattern="yyyy-MM-dd" />" id="promptDay" name="promptDay"/>
                          </div>
                           <div class="laydline">
                            	<label>币种：</label>
                                 <select id="unit" name="unit" class="selectCss">
					                	<option value="CNY" ${con.unit == 'CNY' ? "selected='selected'":""}>人民币</option>
					                	<option value="USD" ${con.unit == 'USD' ? "selected='selected'":""}>美元</option>
					                	<option value="EUR" ${con.unit == 'EUR' ? "selected='selected'":""}>欧元</option>
					                	<option value="HKD" ${con.unit == 'HKD' ? "selected='selected'":""}>港币</option>
				      				</select>
                          </div> 
