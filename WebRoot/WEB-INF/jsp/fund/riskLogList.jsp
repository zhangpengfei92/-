...
<script type="text/javascript">
	...
	function serach(pageNum) {
		...
		form.action = "${path}/order/queryPageRiskStock?pagenum="+pageNum;
		form.submit();
	} 
	...
	function RefreshPage() {
		 window.location.href = "${path}/order/riskLogList";
	}
...
<body>
	<%@include file="../../../head.jsp"%>
		...
		<div class="Rbox">
            <div class="mainbox">
                 <h3><a href="${path}/order/riskLogList" class="on">预警记录</a></h3>
                 <div class="main">
                 	<ul class="otherCss">
                    	<li onclick="changePage('${path}/order/closeOutList');">风控预警</li>
                        <li class="select" onclick="changePage('${path}/order/riskLogList');">预警记录</li>
                    </ul>
                           ...
                           <table width="100%;">
	                      	...
	                      	<c:forEach items="${olist}" var="order" varStatus="st">
								<tr>
									...
									<td><%--<fmt:formatDate value="${order.timeShow}" type="both"/>--%>${order.timeShow}</td>
