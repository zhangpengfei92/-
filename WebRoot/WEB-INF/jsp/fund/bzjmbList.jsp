                 ...
                 <div class="main">
                    ...
                    <div class="mtable">
								...
								<tr>
									...
									<td>
										<c:choose>
											...
											<c:when test="${user.sc==15}">国际期货交易市场</c:when>
											<c:when test="${user.sc==16}">香港期货交易所</c:when>
										</c:choose>
									</td>
									<td>${user.bzjdm}</td>
									<td>${user.bzjname}</td>
									...
									<td><fmt:formatNumber value="${user.bbbz}" pattern="#.##" type="number"/></td>
									<td>
										<c:choose>
		 				...
		 				<div class="page">
							...
							<a style="cursor: pointer;" type="button" onclick="tzfy()" id="btn_skip">跳转</a>
						</div>
                    </div>
               </div>
          </div>
