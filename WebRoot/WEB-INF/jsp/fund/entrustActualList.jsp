			...
			<div class="mtable">
                <table width="100%;">
						...
						<tr>
							...
							<td>
								<c:if test="${entrust.mark eq 24}">
									上海国际能源交易中心
								</c:if>
								<c:if test="${entrust.mark eq 0}">
									深圳证券交易所
								</c:if>
								<c:if test="${entrust.mark eq 1}">
									上海证券交易所
								</c:if>
								<c:if test="${entrust.mark eq 15}">
									国际期货交易市场
								</c:if>
								<c:if test="${entrust.mark eq 3}">
									中国金融期货交易所
								</c:if>
								<c:if test="${entrust.mark eq 4}">
									上海期货交易所
								</c:if>
								<c:if test="${entrust.mark eq 5}">
									大连商品交易所
								</c:if>
								<c:if test="${entrust.mark eq 6}">
									郑州商品交易所
								</c:if>
