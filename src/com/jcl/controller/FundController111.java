...
@Controller
@RequestMapping("/subzhfundxxx")
public class FundController111 {
	public static Logger log = Logger.getLogger(FundController111.class);
	...
	public String ispay(HttpServletRequest request,HttpServletResponse response) {
		...
		Map<String, Object> map= fundServiceimpl.payment(request, response);
	...
	public Map<String, Object> isok(String subzh,String payPage){
		...
		try {
			...
			Boolean flag=true;
			if(payPage=="register_h5/fundChartHFive") {
