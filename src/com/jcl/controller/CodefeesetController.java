/**
F * Copyright (C) 2009 武汉金策略信息科技有限公司
 *
 * 版权所有。
 *
...
public class CodefeesetController {
	...
	public String codefeesetList(HttpSession session, Model model) {
		...
		try {
			...
			log.error("页面参数："+PaginationContext.getPageNum()+"_"+PaginationContext.getPageSize()+"_总记录数：【"+total+"】   "+"当前页：【"+pageNum+"】    "+ "总页数：【"+pages+"】");*/
	...
	public String deleteCodefeeMenu(Integer id) {
		try {
			...
			List<RiskTemplateMenu> rlist=riskTemplateMenuService.selectSchemes(id,1);//1表示手续费方案
