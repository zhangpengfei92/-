...
public interface SubzhService {
	...
	String verifyCost(SubzhObject subzh);
	
	int addSubzhObject(SubzhObject subzh);
	
	int updateSubzhObjectByPrimaryKey(SubzhObject subzh);
	...
	List<Subzh> queryiIsexist(String subzh, String sid, String tid);
