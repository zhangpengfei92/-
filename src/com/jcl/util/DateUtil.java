	...
	public static Timestamp parseUtilDateToSQLTimestamp(java.util.Date date) {
	 ...
	 public static Date getymd(Date date) {
		...
		public static void main(String[] args) {
			String dateTotimeString = DateUtil.dateTotimeString(new Date());
		
			System.out.println(DateUtil.dateTotimeString(DateUtil.strTotimeLong(dateTotimeString)));
		...
		public static String dateTotimeString(Date date) {
		 ...
		 public static Date strTotimeLong(String strDate) {
		...
		public static Date getdateandtime(String timestr) {
			String now = getSystemDateTime();
			String endTime = now.substring(0, 10) +" "+ timestr;
			Date dEndTime = stringToDate(endTime, DATETIME_FULLPATTERN);
			return dEndTime;
		}
}
