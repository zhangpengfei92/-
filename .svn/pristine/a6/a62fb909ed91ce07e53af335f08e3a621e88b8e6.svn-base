...
CREATE TABLE [dbo].[bzjmb](
	...
	[tjdtbzj1] [numeric](18, 3) NULL,			/* 投机多头保证金(按手数) */
    [tjdtbzj2] [numeric](18, 3) NULL,			/* 投机多头保证金率(按金额,百分之) */
	[tjktbzj1] [numeric](18, 3) NULL,			/* 投机空头保证金(按手数)*/
    [tjktbzj2] [numeric](18, 3) NULL,			/* 投机空头保证金率(按金额,百分之) */
...
CREATE TABLE [dbo].[bzjmb](
	...
	[sc] [int] NOT NULL,
	[bzjdm] [varchar](32) NOT NULL,
	[bzjname] [varchar](32) NOT NULL,
	[bbbz] [numeric](18, 3) NULL,
	[tjdtbzj1] [numeric](18, 3)  NULL,
	[tjdtbzj2] [numeric](18, 3)  NULL,
	[tjktbzj1] [numeric](18, 3)  NULL,
	[tjktbzj2] [numeric](18, 3)  NULL,
	[tldtbzj1] [numeric](18, 3) NULL,
	[tldtbzj2] [numeric](18, 3) NULL,
	[tlktbzj1] [numeric](18, 3) NULL,
	[tlktbzj2] [numeric](18, 3) NULL,
	[sqfs] [int] NOT NULL,
	[month] [int] NULL,
	[parentId] [int] NULL,
	[bz] [varchar](4) NULL,
...
CREATE TABLE [dbo].[fund_pzlog](
	...
	[fundtype] [int] NOT NULL, /* 类型 1:配资 资金比例 2:加配资金比例 3:减配  4:追加保证金 5:出金  6:充值 7:提现 */
	[setpro] [int] NULL, /* 比例 */
