        ...
        if(bFlag){
    		...
    		$.ajax({
    			...
    			data : {
					...
					"pcfee1" : pcfee1,
					"pcfee2" : pcfee2,
					"pcamountfee1":pcamountfee1,
					"pcamountfee2":pcamountfee2
				},
				type : "POST",
    			async : false,
...
<body>
	<div class="main">
        <div class="layForm">
	        ...
	        <div class="laydline">
	          	<label style="width:160px;text-align:left;"><font color="red">*</font>平今仓手续费(按手数)：</label>
	        ...
	        <div class="laydline">
	          	<label style="width:160px;text-align:left;"><font color="red">*</font>平昨仓手续费(按手数)：</label>
	            <input type="text" id="pcamountfee1" name="pcamountfee1" value=""/>
	        </div>
	        <div class="laydline">
	            <label style="width:160px;text-align:left;"><font color="red">*</font>平昨仓手续费(按金额%)：</label>
	            <input type="text" id="pcamountfee2" name="pcamountfee2" value=""/>
	        </div>
            <div class="laydline">
