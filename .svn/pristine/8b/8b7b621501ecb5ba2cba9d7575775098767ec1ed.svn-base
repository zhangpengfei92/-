...
function startGo() {
	...
	$("#startButton").css({"background":"#DDDDDD","color":"#fff"});
	$("#stopButton").attr("disabled",false); 
	$("#stopButton").css({"background":"#49a9ee","color":"#fff"});
...
function stopGo() {
	...
	$("#stopButton").css({"background":"#DDDDDD","color":"#fff"});
	$("#startButton").attr("disabled",false); 
	$("#startButton").css({"background":"#49a9ee","color":"#fff"});
}
                      ...
                      <div class="Inputbox">
	                           ...
	                           <span id="seachspan" style="display: none;">
	                              ...
	                              <input type="button" class="cx" onclick="serach('1')" value="查询" style="background: #49a9ee;color:#fff;width:80px;" />
	                           	  ...
	                           	  <input id="startButton" type="button" class="cx" onclick="startGo()" value="开始监听" style="background: #49a9ee;color:#fff;width:80px;" />
	                           	  <input id="stopButton" type="button" class="cx" onclick="stopGo()" value="停止" style="width:80px;"  disabled="disabled"/>
	                           		</span>
	                           </p>
	                           </div>
