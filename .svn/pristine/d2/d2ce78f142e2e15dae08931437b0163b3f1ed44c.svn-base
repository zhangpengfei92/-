	...
	<c:if test="${status eq 0 }">
		...
		$(function(){
			...
			$.post("${path}/trade/getCountdeal",formdate,function(data){
				console.log(data);
				if(data !=null ){
					html=html+"<td>合计:</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>"+data.countVol.toFixed(0)+"</td><td></td><td><td>"+data.countAmout.toFixed(2)+"</td><td>"+data.countFee.toFixed(2)+"</td>";
				}else{
